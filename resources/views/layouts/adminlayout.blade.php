					...
					<div class="navbar-header">
						<div class="top-left-part">
							...
							<a class="logo" href="/admin/dashboard">
								...
								<b>
									<!--This is dark logo icon--><img src="/img/admin-logo.png" alt="home" class="dark-logo" /><!--This is light logo icon--><img src="/img/admin-logo.png" alt="home" class="light-logo" />
								</b>
								<!-- Logo text image you can use text also -->
								<span class="hidden-xs">
									<!--This is dark logo text--><img src="/img/admin-text.png" alt="home" class="dark-logo" /><!--This is light logo text--><img src="/img/admin-text.png" alt="home" class="light-logo" />
								</span>
							</a>
						</div>
						<!-- /Logo -->
						...
						<ul class="nav navbar-top-links navbar-right pull-right">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-user animated flipInY">
									...
									<li role="separator" class="divider"></li>
									<li><a href="#" data-toggle="modal" data-target="#responsive-modal">
